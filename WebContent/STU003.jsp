						...
						<tbody>
							...
							<c:forEach items="${stuList}" var="data">
								<tr>
									...
									<td>${data.id}</td>
									<td>${data.name}</td>
									<td><c:forEach items="${data.attend}" var="attend">${attend.name},</c:forEach></td>
						
									<td><a href="SeeMoreServlet?selectedStuId=${data.id}"><button

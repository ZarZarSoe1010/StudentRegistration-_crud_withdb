				...
				<form action="UpdateUserServlet" method="post">
					...
					<%-- <div class="row mb-4">
						...
						<div class="row mb-4">
							...
							<div class="col-md-4">
								<input type="text" class="form-control" id="id" name="id"
									value="${userBean.id}" readonly="readonly">
							</div>
						</div>
						<div class="row mb-4">
							<div class="col-md-2"></div>
						...
						<div class="row mb-4">
							...
							<div class="col-md-4">
								<input type="password" class="form-control" id="Password"
									name="password" value="${userBean.password}">
							</div>
						</div>
						<div class="row mb-4">
							<div class="col-md-2"></div>
						...
						<div class="row mb-4">
							...
							<div class="col-md-4">
								<select class="form-select" aria-label="Education" id="userRole"
									name="userRole" ${userBean.userRole }>
									<option ${userBean.userRole.equals("Admin") ? 'selected' : '' }
										value="Admin">Admin</option>
									<option ${userBean.userRole.equals("User") ? 'selected' : '' }
